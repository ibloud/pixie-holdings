...
export function outcomeFor(ledger) {
  if (ledger.rights < 35 || ledger.trust < 30 || ledger.access < 25) {
    return "The portfolio grew by transferring unacceptable costs to creators and communities.";
  }
  if (ledger.cash >= 30 && ledger.pressure <= 45 && ledger.capacity >= 30) {
    return "The portfolio remains solvent without abandoning access, rights, or the people doing the work.";
  }
